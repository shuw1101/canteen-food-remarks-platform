            ...
            '<div>',
              '<div class="form-group">',
                '<div class="form-group">',
                    ...
                    '</div>',
                '</div>',
                  '<div class="form-group"><label class="col-sm-2 control-label">名字</label><div class="col-sm-10"><input class="js-title form-control" type="text"></div></div>',
                  '<div class="form-group"><label class="col-sm-2 control-label">描述</label><div class="col-sm-10"><input class="js-link form-control" type="text"></div></div>',
                  '<div class="form-group">',
